...
import br.com.lucas.escola.dominio.aluno.*;
...
public class JDBRepositorioAlunoImpl implements IRepositoioAluno {

    private final Connection connection;

    public JDBRepositorioAlunoImpl(Connection connection) {
